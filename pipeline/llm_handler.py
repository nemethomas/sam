...
def upload_pdf(pdf_path: Path, cfg: dict, timeout: int = 30) -> str:
    ...
    if provider == "google":
        raise NotImplementedError("upload_pdf für provider=google noch nicht implementiert")
...
def run_prompt_with_file(
    ...
    if provider == "google":
        raise NotImplementedError("run_prompt_with_file für provider=google noch nicht implementiert")
